...
private static ServletRunner servletRunner = null;
	...
	public void testLoginSuccess() throws Exception{
		 ...
		 String RequestJSONString = "{ 'messageType':'authenticationRequest', 'messageVersion':1, 'messagePayload':{'username':'test@address.com', 'password':'test', 'userType':'rower'}}";
	...
	public void testLoginPasswordFaliure() throws Exception{
		 ...
		 String RequestJSONString = "{ 'messageType':'authenticationRequest', 'messageVersion':1, 'messagePayload':{'username':'test@address.com', 'password':'somepass', 'userType':'rower'}}";
